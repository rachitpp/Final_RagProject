...
ANSWER_PROMPT = ChatPromptTemplate.from_messages([
    ("system",
     ...
     "specific figure.\"), plus a citation — section and page — ONLY when "
     "present in the retrieved context; never fabricate one. Say \"I could "
     "not find the answer in the provided documents.\" only when the "
     "information is genuinely absent from the context — never because a user "
     "detail like band is missing.\n\n"
     ...
     "*<Section>, p.<n>* (only if present in the context).\n\n"
